...
/******/ 	return __webpack_require__(__webpack_require__.s = "./js/specialist.js");
/******/ })
/************************************************************************/
/******/ ({
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _dom_actions__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./dom-actions */ \"./js/dom-actions.js\");\n/* harmony import */ var _storage_management__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./storage-management */ \"./js/storage-management.js\");\n\n\nObject(_dom_actions__WEBPACK_IMPORTED_MODULE_0__[\"initializeSpecialistsSelector\"])();\n\nfunction renderClientsList(specialistName, clients) {\n  $('.js-thead').html(\"<tr><th>\".concat(specialistName, \"</th><tr>\"));\n  $('.js-tbody').html(clients.sort(function (a, b) {\n    return a.number - b.number;\n  }).map(function (client, index) {\n    return Object(_dom_actions__WEBPACK_IMPORTED_MODULE_0__[\"generateTbodyRow\"])(client, index === 0, true);\n  }).join(''));\n}\n\nfunction bindOnClickEvents() {\n  $('.js-servised').click(function (event) {\n    var clientID = parseInt(event.currentTarget.dataset.value, 10);\n    Object(_storage_management__WEBPACK_IMPORTED_MODULE_1__[\"markAsServiced\"])(clientID);\n  });\n}\n\n$('.js-specialists-dropdown').click(function (event) {\n  var specialistID = parseInt(event.currentTarget.dataset.value, 10);\n  var specialistName = $(event.currentTarget).html();\n  var clientsBySpecialist = Object(_storage_management__WEBPACK_IMPORTED_MODULE_1__[\"getClientsBySpecialist\"])(specialistID);\n  renderClientsList(specialistName, clientsBySpecialist);\n  bindOnClickEvents();\n});\n\n//# sourceURL=webpack:///./js/specialist.js?");
